...
public class ParkingLevel : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            PlayerPrefs.SetInt("Parking", 1);  // Ýlk seviyeyi açýk olarak ayarla
        }
    ...
    private void SetPanelsActiveState()
    {
        ...
        if (unlockLevelsNumber > 1)
        {
            ...
            lvl2.enabled = true;
            PlayerPrefs.SetInt("Parking", 2);  // Geçerli seviyeyi 1 olarak ayarla
        }
        else
        {
            lvl2.enabled = false;
        ...
        if (unlockLevelsNumber > 2)
        {
            ...
            lvl3.enabled = true;
            PlayerPrefs.SetInt("Parking", 3);  // Geçerli seviyeyi 2 olarak ayarla
        }
        else
        {
            lvl3.enabled = false;
        ...
        if (unlockLevelsNumber > 3)
        {
            ...
            PlayerPrefs.SetInt("Parking", 3);  // Geçerli seviyeyi 3 olarak güncelle
        }
